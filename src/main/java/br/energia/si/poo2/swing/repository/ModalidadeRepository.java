...
package br.energia.si.poo2.swing.repository;

import br.energia.si.poo2.swing.interfaces.IModalidadeRepository;
...
public class ModalidadeRepository implements IModalidadeRepository{
    ...
    public void salvar(Modalidade m) {
        ...
        try {
                ...
                ps.setString(1, m.getdescricaoModalidade());
                ...
                if (generatedKeys.next()) {
                        m.setIdModalidade(generatedKeys.getInt(1));
                } else {
    ...
    public Modalidade getById(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                modalidade.setdescricaoModalidade(rs.getString("descricao_modalidade"));
            }
