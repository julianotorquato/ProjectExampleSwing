package br.energia.si.poo2.swing.util.jtable;
...
public class ModalidadeTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int numLinha, int numColuna) {
        ...
        switch (numColuna) {
            case 0:
                return listModalidade.get(numLinha).getIdModalidade();
            case 1:
                return listModalidade.get(numLinha).getdescricaoModalidade();
        }
        return null;
    }
